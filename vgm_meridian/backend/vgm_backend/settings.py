...
# Auto-add Render external URL to ALLOWED_HOSTS
...
# Always allow all .onrender.com subdomains
...
# If EMAIL_HOST_PASSWORD is not set, fall back to console backend (prints to logs)
